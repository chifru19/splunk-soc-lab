...
=======
🛡️ Sentinel Fortress | Splunk SIEM & SOC Lab
Engineer: Frank Fru | GitHub | LinkedIn

Compliance Framework: NIST SP 800-61 (Incident Handling) & NIST CSF 2.0 (Detect/Respond)

📖 Overview
Sentinel Fortress is a managed SIEM and SOC laboratory engineered to provide active defensive monitoring for mission-critical infrastructure.

Originally designed to protect the "Digital Fortress" architecture of Fon Ngwashi Law and Agwo Carlson & Partners, this environment integrates automated adversarial simulations with real-time incident triage and log correlation.

🏗️ Architecture
The lab environment is built on a modular, containerized stack:
...
1. Brute Force & SQL Injection Detection
Using custom SPL (Splunk Processing Language), I correlated raw access logs to identify automated attack patterns targeting the frankfru.com infrastructure.
...
=======
git clone https://github.com/chifru19/splunk-soc-lab.git
>>>>>>> Stashed changes
cd splunk-soc-lab
...
=======
NIST Alignment: Implements the Detect and Respond functions of the NIST Cybersecurity Framework.

Credential Masking: Prevents hardcoded secrets by utilizing environment file masking and .gitignore best practices.

Audit Trail: Maintains a permanent, searchable audit trail for Root-Cause Analysis (RCA).

Engineering by Frank Fru Portfolio: frankfru.com | GitHub: chifru19
>>>>>>> Stashed changes
